...
USER_PROGRAMS := startup-check arg-check exec-check file-check line-check dir-check env-check echo cat ls mkdir rm touch cp rmdir sh
...
INITRD_UTILITIES := echo cat ls mkdir rm touch cp rmdir sh
