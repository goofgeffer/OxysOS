...
/*
 * File: kernel/test/storage/ext2.c
 ...
 *     field offsets are named in <oxys/fs/ext2.h> and are not restated here.
 *
 ...
 *
 *   What `KernelMain` knows is unchanged: <oxys/test/verify.h> declares
