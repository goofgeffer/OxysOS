...
/*
 * File: kernel/include/oxys/gfx/font.h
 ...
 *   - docs/design/CONSOLE.md: the face, its metrics, and why it was
...
#ifndef OXYS_GFX_FONT_H
#define OXYS_GFX_FONT_H
