...
/*
 * File: kernel/include/oxys/dev/mouse.h
 ...
 * stands upon and the restoring of them is <oxys/gfx/cursor.h>, which is graphics
 * and not a device.
 */

#ifndef OXYS_DEV_MOUSE_H
#define OXYS_DEV_MOUSE_H
