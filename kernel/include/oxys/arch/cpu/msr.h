...
/*
 * File: kernel/include/oxys/arch/cpu/msr.h
...
#ifndef OXYS_ARCH_CPU_MSR_H
#define OXYS_ARCH_CPU_MSR_H
 ...
 * sub-task 6.7 finds the kernel's per-processor data with nothing but a
