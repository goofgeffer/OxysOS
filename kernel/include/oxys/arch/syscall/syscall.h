...
/*
 * File: kernel/include/oxys/arch/syscall/syscall.h
...
#ifndef OXYS_ARCH_SYSCALL_SYSCALL_H
#define OXYS_ARCH_SYSCALL_SYSCALL_H
 ...
 * 6.13, and is declared in <oxys/arch/cpu/percpu.h>.
 *
...
#endif /* OXYS_ARCH_SYSCALL_SYSCALL_H */
