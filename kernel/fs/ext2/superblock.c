...
/*
 * File: kernel/fs/ext2/superblock.c
 * Purpose: Implements the reading, validation and writing of the EXT2
 *          superblock: the decoding of the volume's fields from their stored
 *          order into the processor's, the derivation of the geometry that every
 *          other part of this implementation computes from, and the judgement of
 *          whether the volume may be read, may be written, or may not be
 *          addressed at all.
 * Key functions: Ext2ReadSuperblock, Ext2WriteSuperblock, Ext2ReportVolume,
 *          Ext2VolumesRead, Ext2VolumesRefused.
 * References:
 ...
 *   - Linux kernel documentation, the ext4 superblock, consulted as an
