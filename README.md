...
| [`VERSIONING.md`](docs/project/VERSIONING.md) | What a release gets called. One repository, many releases: `Oxys 1`, `Oxys 1.1`, `Oxys Aetos` — which is `Oxys 4` with a name — and editions such as `Oxys Aetos Workspace Edition`, which are varieties of a release rather than successors to it. The latest release is `Oxys 1 Beta`, cut on 2026-09-24 and described by [`RELEASE-1-BETA.md`](docs/project/RELEASE-1-BETA.md), after `Oxys 1 Alpha` of 2026-09-16; Section 11.1 plans `Oxys 1` at about sub-task 11.10. |
