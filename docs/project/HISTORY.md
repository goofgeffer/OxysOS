...
| ---- | ----- | ------ | ------ |
| 2026-09-25 | All | Reference tables: every system call with its wrapper and every error code in `PRIVILEGE.md`, the capacity limits in `ARCHITECTURE.md`; no prose changed | `pending` |
