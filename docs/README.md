...
| [`EXT2.md`](storage/EXT2.md) | The EXT2 volume: its superblock, its group descriptors, its inodes, its directories, the resolution of a path, and the reading and writing of a file. | `kernel/fs/ext2.c` |
