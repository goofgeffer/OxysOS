...
| [`WINDOWS.md`](design/WINDOWS.md) | The window manager of sub-task 9.1: the stack, the focus, the routing of every key and every movement to the window it belongs to, the frame and the palette it is drawn with, and the three windows the default boot entry presents until sub-task 9.5 has a desktop. |
