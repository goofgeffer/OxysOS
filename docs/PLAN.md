...
The backspace now crosses from one row into the row above and stops upon the last
character standing there. That movement was previously refused because the driver
...
**The next work is sub-task 4.3**, PCI configuration-space enumeration.
