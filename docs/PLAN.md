...
**Phase 4 has begun.** Sub-task 4.1 is complete: the serial routine of Phase 1 is
...
**The next work is sub-task 4.2**, the promotion of the display routine to a
formal driver, after which sub-task 4.3 begins PCI enumeration.
