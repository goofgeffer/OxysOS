...
How the machine is brought up, and how it is arranged once it is. These six
...
| [`GRAPHICS.md`](GRAPHICS.md) | The framebuffer: how it is asked for, why its pages are write-combining rather than write-back, the primitives that draw upon it, the font and console that put the boot log back on the screen it displaced, and the page a severe fault draws there. | 6 |
