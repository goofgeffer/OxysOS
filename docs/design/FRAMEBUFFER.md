...
supplies, and everything that has to be settled before anything is drawn upon it.
...
**Where this sits**: the first of the five documents the graphical work of
...
6.4 supplied a console that draws text upon the framebuffer; see [`CONSOLE.md`](CONSOLE.md), Section 2. The whole boot log continues to be
...
`docs/project/TESTING-GRAPHICS.md`, Section 1, records the procedure and the result.
...
no console either — which is recorded in `docs/project/TESTING.md`, Section 4.1,
...
7. **Nothing was drawn but the test pattern**, and the pattern was written by
   ...
   is sub-task 6.3, in [`DRAWING.md`](DRAWING.md), Section 1.
