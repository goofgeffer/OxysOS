...
Seventeen files and two directories: the five utilities of sub-task 7.6, the three
of 8.5, the one of 8.6, the editor and the six utilities added after 8.7, and since
...
**The check programs — four of sub-task 7.6, one of 8.1, one of 8.3, one of 8.4, one of 8.7, one of 9.2 and one of 9.3 — are deliberately not here.**
`arg-check`, `exec-check`, `file-check`, `startup-check`, `line-check`, `dir-check`,
`env-check`, `signal-check`, `window-check` and `init-check` are a test's
