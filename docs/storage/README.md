...
| [`EXT2.md`](EXT2.md) | The EXT2 volume: where the superblock is, how its fields are decoded, where the block group descriptor table lies, and which volumes and tables this kernel refuses to trust. | [`../../kernel/fs/ext2.c`](../../kernel/fs/ext2.c) | 5.1, 5.2 |
