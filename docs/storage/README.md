...
| [`EXT2.md`](EXT2.md) | The EXT2 volume: where the superblock is, how its fields are decoded, and which volumes this kernel refuses to address. | [`../../kernel/fs/ext2.c`](../../kernel/fs/ext2.c) | 5.1 |
